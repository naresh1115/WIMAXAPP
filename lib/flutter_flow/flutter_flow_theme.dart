...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiaryColor = const Color(0xFF0D1B2A);
  late Color alternate = const Color(0xFF0D1B2A);
  late Color primaryBackground = const Color(0xFF0D1B2A);
  late Color secondaryBackground = const Color(0xFF0D1B2A);
